...
[
    ...
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Albioma',
     ...
     'relevant quote from text': 'Releases into water and the soil Biomass facilities'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Albioma',
    ...
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'American Express',
     'variable description': 'Water consumption', 'variable': 'GRI 303', 'value': '303-5', 'unit': '',
     'std_year': '2021',
     'relevant quote from text': '2020-2021 ESG Report: Environmental Performance Data Summary page 63'},
    ...
    {'kpi': 'emissions-to-water', 'score': 0.8, 'rank': 2.0, 'doc_org_std': 'Bayer',
     ...
     'unit': 'Million m³', 'std_year': '2021', 'relevant quote from text': 'tablenum-0'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'BillerudKorsnäs',
     ...
     'unit': 'million m³', 'std_year': '2021', 'relevant quote from text': "[2021.0, 135, 'million m³']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'BillerudKorsnäs',
     'variable description': 'Emissions to water (303-4)-COD', 'variable': 'COD', 'value': '27,156', 'unit': 'tonnes',
     'std_year': '2021', 'relevant quote from text': "[2021.0, 27,156, 'tonnes']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'BillerudKorsnäs',
     'variable description': 'Emissions to water (303-4)-TSS', 'variable': 'TSS', 'value': '3,830', 'unit': 'tonnes',
     'std_year': '2021', 'relevant quote from text': "[2021.0, 3,830, 'tonnes']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'BillerudKorsnäs',
     ...
     'relevant quote from text': "[2021.0, 131, 'tonnes']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'BillerudKorsnäs',
     'variable description': 'Emissions to water (303-4)-Nitrogen (N)', 'variable': 'Nitrogen (N)', 'value': '434',
     'unit': 'tonnes', 'std_year': '2021', 'relevant quote from text': "[2021.0, 434, 'tonnes']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'DEG Deutsche EuroShop',
     ...
     'std_year': '2021', 'relevant quote from text': 'tablenum-1'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'DEG Deutsche EuroShop',
    ...
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Mondi Group',
     ...
     'relevant quote from text': 'SASB Emissions to water 34,141 tonnes COD'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Mondi Group',
     ...
     'relevant quote from text': 'SASB Emissions to water 109 tonnes AOX'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Mondi Group',
     ...
     'relevant quote from text': 'SASB Emissions to air 4.4 million tonnes CO2e'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Mondi Group',
    ...
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'Responsible Business Report',
     ...
     'std_year': '2020', 'relevant quote from text': "[3.0, 'Water crisis', '(automation, robotics, Al)']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'SCGG',
     'variable description': 'ESG Rating',
     'variable': 'ESG Rating', 'value': '382', 'unit': '', 'std_year': '2021',
     'relevant quote from text': "['ESG Rating', nan, '382', nan, nan, nan, '401', '382', nan]"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'SCGG',
     'variable description': 'ESG Rating',
     'variable': 'ESG Rating', 'value': '228', 'unit': '', 'std_year': '2021',
     'relevant quote from text': "['ESG Rating', '228', nan, nan, nan, nan, nan, nan, '202']"},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'SCGG',
     'variable description': 'ESG Rating',
    ...
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'UPM',
     'variable description': 'Emissions to water', 'variable': 'Chemical Oxygen Demand', 'value': '59,000 t',
     'unit': '',
     'std_year': '2021', 'relevant quote from text': 'tablenum-0'},
    {'kpi': 'emissions-to-water', 'score': 1.0, 'rank': 1.0, 'doc_org_std': 'UPM',
     'variable description': 'Emissions to water', 'variable': 'Absorbable Organic Halogens', 'value': '280 t',
     'unit': '',
     'std_year': '2021', 'relevant quote from text': 'tablenum-0'},
